...
// AppModuleBasic implements the AppModuleBasic interface for the node module.
...
// RegisterLegacyAminoCodec registers the node module's types on the LegacyAmino codec.
...
// AppModule implements the AppModule interface for the node module.
type AppModule struct {
	AppModuleBasic

	keeper keeper.NodeKeeper
}
...
// RegisterInvariants registers the node module's invariants.
func (am AppModule) RegisterInvariants(ir sdk.InvariantRegistry) {
	// TODO: Implement invariants
	_ = ir
}

// InitGenesis performs the node module's genesis initialization.
...
// ExportGenesis returns the node module's exported genesis state as raw JSON bytes.
...
// BeginBlock executes all ABCI BeginBlock logic respective to the node module.
func (am AppModule) BeginBlock(_ sdk.Context, _ abci.RequestBeginBlock) {}

// EndBlock executes all ABCI EndBlock logic respective to the node module.
