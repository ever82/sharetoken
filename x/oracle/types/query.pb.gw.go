...
var (
	pattern_Query_Price_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"sharetoken", "oracle", "price", "symbol"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Prices_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"sharetoken", "oracle", "prices"}, "", runtime.AssumeColonVerbOpt(true)))
)
